 ...
 */
public class OverlayHideShow implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    USGSOverlay overlay = USGSOverlay.create(bounds, srcImage, map);
    register(overlay);
  }

  public final native void register(USGSOverlay overlay) /*-{
    $wnd['overlay'] = overlay;
  }-*/;
